        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-[#E0E0E0] text-lg md:text-xl mb-10 leading-relaxed max-w-2xl mx-auto">
              Contactez-nous dès aujourd'hui pour une consultation gratuite et découvrez comment nous pouvons optimiser vos systèmes informatiques.
            </p>
